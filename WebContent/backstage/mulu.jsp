			...
			<div class="sidebar-scroll">
				<nav>
				    <ul class="nav">
						...
						<li><a href="${pageContext.request.contextPath }/backstage/mulu.jsp" class="active"><i class="lnr lnr-chart-bars"></i> <span>目录管理</span></a></li>
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
	...
	<script src="${pageContext.request.contextPath }/backstage/js/mulu.js"></script>
				...
				<form class="layui-form"   id="insertForm">
						  <div style="margin-top: 50px;"  class="layui-form-item">
						    ...
						    <div class="layui-input-block">
						      ...
						      <input type="text" id="cataloguename" name="cataloguename" required   lay-verify="required" placeholder="请输入目录名称" autocomplete="off" class="layui-input">
						    </div>
						  </div>
						    <input type="hidden" id="userid" name="userid" value="${sessionScope.user.id }"><!-- 
						  <div style="margin-top: 30px;"  class="layui-form-item">
						    <label class="layui-form-label">输入框</label>
						    <div class="layui-input-block">
						      <input type="text" id="updaloadfilenumbermax" name="updaloadfilenumbermax" required   lay-verify="required" placeholder="请输入允许最大文件上传大小（kb）" autocomplete="off" class="layui-input">
						    </div>
						  </div>					  						  						  
						 --><div class="layui-form-item">
						    <label class="layui-form-label">选择框</label>
						    <div class="layui-input-block">
						      <select name="jurisdiction" id="jurisdiction" lay-filter="aihao">					       
						  ...
						  <div style="margin-top: 30px;"  class="layui-form-item">
						    <label class="layui-form-label">输入框</label>
						    <div class="layui-input-block">
						      <input type="text" id="filenumbermax" name="filenumbermax" required   lay-verify="required" placeholder="请输入目录允许最大文件数量" autocomplete="off" class="layui-input">
						    </div>
						  </div>
						 		  						  							
						  <div class="layui-form-item" style="margin-left: 100px;margin-top: 80px;">
						    <div class="layui-input-block" >
						      <button class="layui-btn" onclick="insert()">立即提交</button>
			...
			<div class="modal-content">
				...
				<form class="layui-form"  id="updateForm">
						  ...
						  <div style="margin-top: 30px;"  class="layui-form-item">
						    <label class="layui-form-label">输入框</label>
						    <div class="layui-input-block">
						      <input type="text" id="updaloadfilenumbermax" name="updaloadfilenumbermax" required   lay-verify="required" placeholder="请输入允许最大文件上传大小" autocomplete="off" class="layui-input">
						    </div>
						  </div>
...
<!--上传文件  -->
<div class="modal fade" id="addfilemodle" tabindex="-1" role="dialog"
		aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
				...
				<form class="layui-form"  method="post"  action="${pageContext.request.contextPath}/user/uploadfilemy" id="wenjian"  enctype="multipart/form-data">
						  ...
						  <div class="layui-form-item" style="margin-left: 100px;margin-top: 80px;">
						    <div class="layui-input-block" >
						      <button class="layui-btn"  type="button" onclick="check(${sessionScope.user.id})">立即提交</button>
						      <button type="reset" class="layui-btn layui-btn-primary">重置</button>
						    </div>
						  </div>
				</form>
