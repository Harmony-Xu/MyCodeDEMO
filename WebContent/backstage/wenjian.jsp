			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${pageContext.request.contextPath }/backstage/wenjian.jsp" class="active"><i class="lnr lnr-cog"></i> <span>文件管理</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
	...
	<script src="${pageContext.request.contextPath }/backstage/js/wenjian.js"></script>
	<!--添加拟态框  -->
	<div class="modal fade" id="insertModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="layui-form"  id="insertForm" method="post" >
						  <div style="margin-top: 50px;"  class="layui-form-item">
						    <label class="layui-form-label">输入框</label>
						    <div class="layui-input-block">
						      <input type="text" id="title" name="title" required  placeholder="请输入标题" autocomplete="off" class="layui-input">
						    </div>
						  </div>
						  <div style="margin-top: 20px;"  class="layui-form-item">
						    <label class="layui-form-label">输入框</label>
						    <div class="layui-input-block">
						      <input  type="text" id="count" name="count" required  placeholder="请输入内容" autocomplete="off" class="layui-input">
						    </div>
						  </div>											  						  							
				...
				<form class="layui-form" id="updateForm"  method="post"  enctype="multipart/form-data">
						  <div style="margin-top: 50px;"  class="layui-form-item">
						    ...
						    <input type="hidden" id="id" name="id" >
						      <input type="text" id="title" name="title" required   lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						    </div>
						  </div>
						  ...
						  <div style="margin-top: 20px;"  class="layui-form-item">
						    <label class="layui-form-label">输入框</label>
						    <div class="layui-input-block">
						      <input type="text" id="count" name="count" required   lay-verify="required" placeholder="请输入内容" autocomplete="off" class="layui-input">
						    </div>
						  </div>						  						  							
						  <div class="layui-form-item" style="margin-left: 100px;margin-top: 80px;">
						    <div class="layui-input-block" >
