			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${pageContext.request.contextPath }/backstage/admin/wenjian.jsp" class="active"><i class="lnr lnr-cog"></i> <span>文件管理</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
...
<script type="text/html" id="barDemo">
  <div class="layui-btn-container" >
	...
	<script src="${pageContext.request.contextPath }/backstage/admin/js/wenjian.js"></script>
	<!--修改拟态框  -->
